...
class Main:
    ...
    def main(self):
        ...
        #quantization = common.quantization.AlternativeFixedPointQuantization(1, self.args.precision)
        #quantization = common.quantization.AdaptiveAlternativeFixedPointQuantization(self.args.precision)
