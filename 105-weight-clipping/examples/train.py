...
class Main:
    ...
    def main(self):
        ...
        trainer.quantization = common.quantization.AdaptiveAlternativeUnsymmetricUnsignedRoundedFixedPointQuantization(self.args.precision)
        trainer.projection = attacks.weights.projections.BoxProjection(-self.args.w_max, self.args.w_max)
